...
<html>
  ...
  <!-- HTML code can reside ABOVE and BELOW the starting and closing PHP tags -->
    ...
    $sql= "SELECT DISTINCT Show_id,Show_name,Venue,Start_time,End_time,Show_description,Ticket_price,Show_type FROM Shows
            s INNER JOIN Attendees a ON a.Attendee_show_id=s.Show_id WHERE a.attendee_user_id='$userid';";
    ...
    $result = mysqli_query($db_server, $sql);
      ...
      echo "<br><br>";
            ...
            echo "Currently you are not attending any of the events";
