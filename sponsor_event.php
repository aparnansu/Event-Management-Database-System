...
document.getElementById("Show_name").value = x[0].innerHTML;
  ...
  Event name:<input type="text" id="Show_name" name="Show_name" required />
</div>
  <div class="input-group">
  Company name:<input type="text" id="company_name" name="company_name" required/>
</div>
<div class="input-group">
  Sponsor amount:<input type="number" id="sponsor_amount" name="sponsor_amount" required />
</div>
<div class="input-group">
	<label>Sponsor type</label>
	<select name="sponsor_type">
		<option value="Title" selected>Title</optionTitle>
